...
export const Route = createFileRoute("/auth")({
  head: () => ({
    meta: [
      { title: "Вход · Муза" },
      { name: "description", content: "Войдите или создайте аккаунт в Музе." },
    ],
  }),
  component: AuthPage,
});
      ...
      <div className="flex flex-1 items-center justify-center px-6 pb-20">
        <div className="w-full max-w-sm">
          <h1 className="font-display text-4xl font-light tracking-tight">
            {mode === "signin" ? "С возвращением." : "Начнём писать."}
          </h1>
          <p className="mt-2 text-sm italic text-muted-foreground">
            {mode === "signin" ? "Продолжите фразу с того места, где остановились." : "Страница уже ждёт."}
          </p>
