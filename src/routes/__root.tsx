...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Тихая комната для письма: стол, черновики, ежедневные подсказки и Добрый Друг Диди, которого можно позвать к тексту." },
      { property: "og:title", content: "Комната со столом" },
      { name: "twitter:title", content: "Комната со столом" },
      { property: "og:description", content: "Тихая комната для письма: стол, черновики, ежедневные подсказки и Добрый Друг Диди, которого можно позвать к тексту." },
      { name: "twitter:description", content: "Тихая комната для письма: стол, черновики, ежедневные подсказки и Добрый Друг Диди, которого можно позвать к тексту." },
