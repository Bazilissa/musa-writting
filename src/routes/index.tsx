...
function LandingRoomIllustration() {
  return (
    <svg
      className="pointer-events-none absolute bottom-[8vh] left-1/2 h-[68vh] w-[min(1180px,100vw)] -translate-x-1/2 text-ink opacity-75 lg:bottom-[4vh] lg:left-auto lg:right-[-3vw] lg:h-[74vh] lg:w-[min(960px,52vw)] lg:translate-x-0"
